    ...
    "userInterface": {
        ...
        "respondAll": function (status) {
            ...
            for (index = 0; index < tarteaucitron.job.length; index += 1) {
                ...
                key = service.key;
                if (tarteaucitron.state[key] !== status && service.needConsent) {
        ...
        "color": function (key, status) {
            ...
            if (status === true && tarteaucitron.services[key].needConsent) {
            ...
            for (index = 0; index < sum; index += 1) {
                if (tarteaucitron.services[tarteaucitron.job[index]].needConsent) {
